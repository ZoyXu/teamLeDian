...
class order extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            selectsize: null, // 存儲所選的尺寸
            selectedPrice: 0, // 存儲所選尺寸的價格
            selecting: 0, // 所選的配料價格,預設為10
            productCkeck: {
                size: "",
                temperatures: "",
                sugar: "",
    ...
    handleSizeChange = (size) => {
        this.setState({
            selectsize: size,
            totalPrice: this.calculateTotalPrice(size, this.state.selectedIngredients)
        });
    }
                                                ...
                                                {/* 尺寸選項 */}
                                                {
                                                    ...
                                                    <div className="row sizecheck">
                                                        ...
                                                        {this.state.selectedProduct.products_price_1 ?
                                                            <div className="col-4 form-check">
                                                                <input className="form-check-input order" type="radio" name="size" id="large" value="large" data-price={this.state.selectedProduct.products_price_1} onChange={() => this.handleSizeChange(2)}></input>
                                                        ...
                                                        {this.state.selectedProduct.products_price_2 ?
                                                            <div className="col-4 form-check">
                                                                <input className="form-check-input order" type="radio" name="size" id="extraLarge" value="size" onChange={() => this.handleSizeChange(3)} ></input>
                                                        ...
                                                        this.state.selectedProduct.choose_ingredient === 1 ?
                                                            ...
                                                            <div className="row sugarinesscheck">
                                                                ...
                                                                {this.state.modelproductingredients.ingredient_1 && (
                                                                    <div className="col-6 form-check" >
                                                                        <input className="form-check-input order" type="checkbox" name="ingredients" id="ing1" value="1" data-price={this.state.modelproductingredients.ingredient_price_1} onChange={this.handleIngredientChange}></input>
                                                                ...
                                                                {this.state.modelproductingredients.ingredient_2 && (
                                                                    <div className="col-6 form-check">
                                                                        <input className="form-check-input order" type="checkbox" name="ingredients" id="ing2" value="2" data-price={this.state.modelproductingredients.ingredient_price_2} onChange={this.handleIngredientChange}></input>
                                                                ...
                                                                {this.state.modelproductingredients.ingredient_3 && (
                                                                    <div className="col-6 form-check">
                                                                        <input className="form-check-input order" type="checkbox" name="ingredients" id="ing3" value="3" data-price={this.state.modelproductingredients.ingredient_price_3} onChange={this.handleIngredientChange}></input>
                                                                ...
                                                                {this.state.modelproductingredients.ingredient_5 && (
                                                                    <div className="col-6 form-check">
                                                                        <input className="form-check-input order" type="checkbox" name="ingredients" id="ing5" value="5" data-price={this.state.modelproductingredients.ingredient_price_5} onChange={this.handleIngredientChange}></input>
                                                                ...
                                                                {this.state.modelproductingredients.ingredient_6 && (
                                                                    <div className="col-6 form-check">
                                                                        <input className="form-check-input order" type="checkbox" name="ingredients" id="ing6" value="6" data-price={this.state.modelproductingredients.ingredient_price_6} onChange={this.handleIngredientChange}></input>
                                                                ...
                                                                {this.state.modelproductingredients.ingredient_7 && (
                                                                    <div className="col-6 form-check">
                                                                        <input className="form-check-input order" type="checkbox" name="ingredients" id="ing7" value="7" data-price={this.state.modelproductingredients.ingredient_price_7} onChange={this.handleIngredientChange}></input>
                                                                ...
                                                                {this.state.modelproductingredients.ingredient_8 && (
                                                                    <div className="col-6 form-check">
                                                                        <input className="form-check-input order" type="checkbox" name="ingredients" id="ing8" value="8" data-price={this.state.modelproductingredients.ingredient_price_8} onChange={this.handleIngredientChange}></input>
                                                                ...
                                                                {this.state.modelproductingredients.ingredient_9 && (
                                                                    <div className="col-6 form-check">
                                                                        <input className="form-check-input order" type="checkbox" name="ingredients" id="ing9" value="9" data-price={this.state.modelproductingredients.ingredient_price_9} onChange={this.handleIngredientChange}></input>
                                                                ...
                                                                {this.state.modelproductingredients.ingredient_10 && (
                                                                    <div className="col-6 form-check">
                                                                        <input className="form-check-input order" type="checkbox" name="ingredients" id="ing10" value="10" data-price={this.state.modelproductingredients.ingredient_price_10} onChange={this.handleIngredientChange}></input>
                                                                ...
                                                                {this.state.modelproductingredients.ingredient_11 && (
                                                                    <div className="col-4 form-check">
                                                                        <input className="form-check-input order" type="checkbox" name="ingredients" id="ing11" value="11" data-price={this.state.modelproductingredients.ingredient_price_11} onChange={this.handleIngredientChange}></input>
